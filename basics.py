...
def is_var(tm: term) -> bool:
    return isinstance(tm, Var)


def is_const(tm: term) -> bool:
    return isinstance(tm, Const)


def is_abs(tm: term) -> bool:
    return isinstance(tm, Abs)


def is_comb(tm: term) -> bool:
    return isinstance(tm, Comb)
...
def is_binop(name: str, tm: term) -> bool:
    return (
        isinstance(tm, Comb)
        and isinstance(tm.fun, Comb)
        and isinstance(tm.fun.fun, Const)
        and tm.fun.fun.name == name
    )
...
def is_unop(name: str, tm: term) -> bool:
    return isinstance(tm, Comb) and isinstance(tm.fun, Const) and tm.fun.name == name

...
Items 5, 14 are deeper restructurings (dependent kinds; staged `Φ`-contexts on declarations). Items 7–8 are housekeeping. Items 9, 10, 12, 16, 18 are extensions beyond the base kernel. Item 17 is a known deliberate deviation. Item 2 was folded into item 15 and shipped.
